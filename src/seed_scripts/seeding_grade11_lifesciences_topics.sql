-- Seeding script for Grade 11 Life Sciences topics based on the standard Department of Basic Education CAPS curriculum.
-- Assumes parent subject with code 'LFS11' exists in the subjects table.
