-- Seeding script for Grade 11 Chemistry topics based on the Siyavula Everything Science Grade 11 Physical Sciences textbook and CAPS curriculum.
-- Assumes parent subject with code 'CHEM11' exists in the subjects table.
